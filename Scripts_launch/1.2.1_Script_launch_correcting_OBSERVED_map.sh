#!/bin/bash
#SBATCH --job-name=CorrectObsMap
#SBATCH --output=resultat.CorrectingObservedMap.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.2.1_Correcting_OBSERVED_MAP_with_FIELD_SAMPLES_plots_OPTION.R 
