...
#SBATCH --output=resultat.SpectralSeparability.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/3.3.2_Assessing_spectral_separability_for_New_typology.R 
