#!/bin/bash
#SBATCH --job-name=MergePlots
#SBATCH --output=resultat.MergingAllPlots.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.3_Merging_all_learning_plots.R 
