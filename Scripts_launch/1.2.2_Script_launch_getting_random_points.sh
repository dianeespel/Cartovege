#!/bin/bash
#SBATCH --job-name=RandomPoints
#SBATCH --output=resultat.GettingRandomPoints.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.2.2_Getting_random_points_within_OBSERVED_MAP.R 
