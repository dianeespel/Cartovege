#!/bin/bash
#SBATCH --job-name=FinalStack
#SBATCH --output=resultat.FinalRasterStack.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/3.2.2_Creating_filtered_final_raster_stack.R 
