#!/bin/bash
#SBATCH --job-name=SpectralIndices
#SBATCH --output=resultat.SpectralIndices.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/2.3_Computing_spectral_indices.R 
