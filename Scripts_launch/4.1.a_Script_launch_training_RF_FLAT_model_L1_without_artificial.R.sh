#!/bin/bash
#SBATCH --job-name=TuningFLAT_L1_without
#SBATCH --output=result.Tuning_RF_FLAT_L1_without_artificial.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/4.1.a_Training_RF_FLAT_model_L1_without_artificial.R
