#!/bin/bash
#SBATCH --job-name=DeriveSlope
#SBATCH --output=resultat.DerivingSlope.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/2.1_Deriving_slope_from_dem.R 
