#!/bin/bash
#SBATCH --job-name=RasterTotal
#SBATCH --output=resultat.RasterTotal.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/2.5_Creating_raster_total.R
