#!/bin/bash
#SBATCH --job-name=PhotointPlots
#SBATCH --output=resultat.CreatingPhotointerpretedPlots.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.2.3_Creating_and_Sorting_PHOTO-INTERPRETED_plots.R 
