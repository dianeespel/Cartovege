#!/bin/bash
#SBATCH --job-name=IslandMask
#SBATCH --output=resultat.IslandMasking.txt
#SBATCH --chdir=/home/genouest/cnrs_umr6553/despel/Gollum
#SBATCH --ntasks=1
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/2.2_Masking_rasters.R 
