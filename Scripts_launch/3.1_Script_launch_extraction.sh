#!/bin/bash
#SBATCH --job-name=ExtractPixels
#SBATCH --output=resultat.ExtractPixels.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/3.1_Extracting_imagery_data_within_plots.R
