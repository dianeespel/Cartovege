#!/bin/bash
#SBATCH --job-name=SpectralClustering
#SBATCH --output=resultat.SpectralClusteringHAC.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/3.3.1.b_Find_spectral_confusions_with_HAC.R
