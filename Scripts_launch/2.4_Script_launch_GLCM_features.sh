#!/bin/bash
#SBATCH --job-name=GCLMTexture
#SBATCH --output=resultat.GCLMTexture.txt
...
conda activate cartovege_env_GLCMTextures
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/2.4_Computing_GLCM_features.R
