#!/bin/bash
#SBATCH --job-name=SamplesPlots
#SBATCH --output=resultat.SamplesPlots.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.1.1_Creating_SAMPLES_plots.R
