#!/bin/bash
#SBATCH --job-name=CorrectCentroids
#SBATCH --output=resultat.CorrectCentroids.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/1.1.2.b_Correcting_SAMPLES_plots_OPTION.R 
