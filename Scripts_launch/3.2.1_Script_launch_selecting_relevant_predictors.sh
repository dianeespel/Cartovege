#!/bin/bash
#SBATCH --job-name=SelectPredictors
#SBATCH --output=resultat.SelectingPredictorsPCA.txt
...
TMPDIR=/scratch/despel/Tempo/ Rscript /home/genouest/cnrs_umr6553/despel/CARTOVEGE/scripts/ALL/3.2.1_Selecting_relevant_predictors_with_PCA.R 
