...
for (source in source_list) {
  ...
  FILE2 = paste0(open_plots_path, "/Quadrats_", District, "_", Island, "_ALL_", source, "_SAMPLES_Centroids_corrected_EPSG32739.csv")
  ...
  # Write the polygons shapefile to disk with a descriptive filename including District, Island, and data source
  ...
  # Convert the original points data frame to sf points object, using xcoord_m and ycoord_m as coordinates
